...
// NOTE: There are no 8-bit FNV1 Perfect hash functions for the C programming language
// NOTE: There are no 16-bit FNV1 Perfect hash functions for the C programming language
