...
// Longest run of continguous hashes starting from least hash (least hash of 0)
uint8_t c_perfect_hash_8bit_fnv1a_func_1(const char* string, const size_t string_len)
{
